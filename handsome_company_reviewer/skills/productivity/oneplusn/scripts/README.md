...
```bash
gh issue list --repo test-team/agent_workflow --assignee @me --state open
```
...
|------|--------|------|------|----------|------|----------|------|
| test-dev-01 | @test-boss-dev01 | test-boss+dev01@test.local | developer | hermes | 18001 | hindsight, search | active |
| test-rev-01 | @test-boss-rev01 | test-boss+rev01@test.local | reviewer | hermes | 18002 | — | active |
...
| 员工 | 轮询频率 | 备注 |
|------|---------|------|
| test-dev-01 | `*/30 * * * *` | 跑 `oneplusn-poll.sh test-dev-01 test-team agent_workflow` |
| test-rev-01 | `15,45 * * * *` | 跑 `oneplusn-poll.sh test-rev-01 test-team agent_workflow` |

---

*本文档版本: v1.0 | 2026-07-08 17:06:34 | 组织: test-team | 仓库: agent_workflow*