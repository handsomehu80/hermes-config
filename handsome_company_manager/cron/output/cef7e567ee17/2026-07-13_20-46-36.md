...
确认:Issue #2 只有 1 条评论,是 2026-07-09 我自己发的欢迎评论(`author.login=handsomehu80` 因为 `gh` CLI 用老板账号,但 body 签名是 `— 项目牧羊人 · Handsome-Manager`),属于 §6 pitfall #4 提到的 "in-body signature" 场景 — 这不是新反馈,是 smoke test 自身。

完全匹配 §5 的验证案例:`Smoke Test Issue #2 ... PM's welcome comment at 2026-07-09T12:22:24Z, last activity 2026-07-09T12:22:34Z. The next day's poll at the same offset fired [SILENT] because no one else had commented. Correct.`
