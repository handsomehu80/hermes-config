...
- 1 条 comment，author=`handsomehu80`（CLI 账号），但 body 签名是 `— 项目牧羊人 · Handsome-Manager`（PM 本人）
- updatedAt=2026-07-09T12:22:34Z（已 4 天无新活动）
- 匹配 cron-polling-behavior §5 的冒烟测试 pattern：本人已 ack，后续每次轮询都应 `[SILENT]`
- 无其他 open issue 分配给我
